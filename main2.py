...
win.keypad(1)
curses.noecho()  # we dont want to listen anything but keypad
curses.curs_set(0)
win.border(0)
win.nodelay(1)  # waiting to user hits next key
...
while key != ESC:
    ...
    snake.insert(0, (y, x))  # like append
